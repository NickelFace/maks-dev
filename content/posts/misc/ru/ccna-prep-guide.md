...
> **Заметка:** Структурированный план подготовки к CCNA теперь живёт по адресу [/roadmap/ccna/](/roadmap/ccna/). Эта страница остаётся как развёрнутый список ресурсов.
